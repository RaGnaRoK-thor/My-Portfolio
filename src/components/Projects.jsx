...
function ProjectCard({ project }) {
    ...
    return (
        <motion.div
            ...
            className={`perspective-container ${hasLink ? "cursor-pointer" : ""}`}
                ...
                <div className="relative glass rounded-2xl overflow-hidden border border-white/[0.06] group-hover:border-white/[0.12] transition-all duration-500">
                    ...
                    <div className="p-5">
                        ...
                        <div className="flex items-start justify-between mb-3">
                            ...
                            {hasLink && (
                                <div className="p-2 rounded-lg glass text-white/40 group-hover:text-white transition-colors">
                        ...
                        {/* Hover indicator — only for projects with live links */}
                        {hasLink && (
                            <motion.div
